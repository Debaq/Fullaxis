...
from PySide6.QtWidgets import QApplication, QMainWindow ,QWidget ,QToolBar ,QHBoxLayout, QStatusBar ,QLineEdit ,QPushButton ,QTextEdit , QVBoxLayout 
    ...
    def __init__(self, parent , menu):
        ...
        if(len(serial_ports)> 0):
            ...
            while antal < antalporte:
                ...
                button_action.triggered.connect(lambda checked, txt = txt: self.valgAfComportClick("COM7"))
...
class MainWindow(QMainWindow):  
    ...
    @QtCore.Slot(bool)
    def on_toggled(self, checked =True):
