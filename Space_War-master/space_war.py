...
def intro():
    ...
    while True:
        ...
        label("Bienvenido",width/2-100,100,50,purple)
        label("a",width/2-10,170,30,green)
        label("Space War",width/2-150,200,60,red)
        label("Destruye a todos los enemigos",width/2-230,500,30,orange)
        Button("Salid",width-250,height/2+100,100,50,red,brightred,quitgame)
        Button("Iniciar",150,height/2+100,100,50,green,brightgreen,gameloop)
        Button("Información",335,height/2+100,100,50,blue,brightblue,info)
...
def gameover():
    ...
    while True:
        ...
        label("Perdiste",width/2-250,height/2-200,100,brightred)
        Button("Salir",width-250,height/2+100,100,50,red,brightred,quitgame)
        Button("Reintentar", 150, height/2+100, 100, 50, green, brightgreen, gameloop)
        Button("Información",335,height/2+100,100,50,blue,brightblue,info)
...
def arduino():
    ...
    device = port[0]
    arduino_connect = serial.Serial(device.device, 115200, timeout=1.)
