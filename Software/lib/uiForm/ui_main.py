...
################################################################################
## Form generated from reading UI file 'maingRwJVe.ui'
##
...
"")
        ...
        self.stackedWidget = QStackedWidget(self.FrameCenter_L5)
        self.stackedWidget.setObjectName(u"stackedWidget")
        self.stackedWidget.setGeometry(QRect(0, 0, 740, 740))
        self.stackedWidget.setMinimumSize(QSize(740, 615))
        self.home_page = QWidget()
        self.home_page.setObjectName(u"home_page")
        self.home_page.setMaximumSize(QSize(16777215, 301))
        self.stackedWidget.addWidget(self.home_page)
        self.home_workspace = QWidget()
        self.home_workspace.setObjectName(u"home_workspace")
        self.home_workspace.setMaximumSize(QSize(491, 301))
        self.stackedWidget.addWidget(self.home_workspace)
...
"")
        ...
        self.FrameCenter_L5 = QFrame(self.FrameCenter_L4)
        self.FrameCenter_L5.setObjectName(u"FrameCenter_L5")
        self.horizontalLayout_3 = QHBoxLayout(self.FrameCenter_L5)
