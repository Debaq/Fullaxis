...
class Ui_win_principal(object):
    def setupUi(self, win_principal):
        ...
        self.verticalWidget_3 = QWidget(win_principal)
        ...
        self.verticalFrame = QFrame(win_principal)
        ...
        self.pushButton_4 = QPushButton(win_principal)
        ...
        self.listView = QListView(win_principal)
        ...
        self.verticalFrame_4 = QFrame(win_principal)
