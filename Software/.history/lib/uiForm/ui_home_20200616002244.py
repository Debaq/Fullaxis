...
################################################################################
## Form generated from reading UI file 'homelXBkoz.ui'
##
...
class Ui_HomeWidget(object):
    def setupUi(self, HomeWidget):
        ...
        self.HW_HeaderLeft.setStyleSheet(u"background-color: rgb(237, 212, 0);")
        ...
        self.HW_HeaderRigth.setStyleSheet(u"background-color: rgb(252, 233, 79);")
        ...
        self.HW_BodyLeft.setStyleSheet(u"background-color: rgb(92, 53, 102);")
        ...
        self.HW_BodyRigth.setStyleSheet(u"background-color: rgb(233, 185, 110);")
