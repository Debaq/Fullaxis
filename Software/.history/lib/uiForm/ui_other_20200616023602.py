...
class Ui_OtherWidget(object):
    def setupUi(self, OtherWidget):
        if not OtherWidget.objectName():
            OtherWidget.setObjectName(u"OtherWidget")
        OtherWidget.resize(890, 570)
        self.layoutOtherWidget = QVBoxLayout(OtherWidget)
        self.layoutOtherWidget.setSpacing(0)
        self.layoutOtherWidget.setObjectName(u"layoutOtherWidget")
        self.layoutOtherWidget.setContentsMargins(0, 0, 0, 0)
        self.HW_Header = QFrame(OtherWidget)
        ...
        self.layoutOtherWidget.addWidget(self.HW_Header)

        self.HW_Body = QFrame(OtherWidget)
        ...
        self.layoutOtherWidget.addWidget(self.HW_Body)


        self.retranslateUi(OtherWidget)

        QMetaObject.connectSlotsByName(OtherWidget)
    # setupUi

    def retranslateUi(self, OtherWidget):
        OtherWidget.setWindowTitle(QCoreApplication.translate("OtherWidget", u"Form", None))
    # retranslateUi
