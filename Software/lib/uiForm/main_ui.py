...
"")
        ...
        self.Frame_center_root = QtWidgets.QFrame(self.centralwidget)
        self.Frame_center_root.setObjectName("Frame_center_root")
        self.Center_Layout_root = QtWidgets.QHBoxLayout(self.Frame_center_root)
        self.Center_Layout_root.setContentsMargins(0, 0, 0, 0)
        self.Center_Layout_root.setSpacing(0)
        self.Center_Layout_root.setObjectName("Center_Layout_root")
        self.Fame_lateral = QtWidgets.QFrame(self.Frame_center_root)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Fame_lateral.sizePolicy().hasHeightForWidth())
        self.Fame_lateral.setSizePolicy(sizePolicy)
        self.Fame_lateral.setObjectName("Fame_lateral")
        self.Lateral_layout = QtWidgets.QVBoxLayout(self.Fame_lateral)
        ...
        self.Frame_center = QtWidgets.QFrame(self.Frame_center_root)
